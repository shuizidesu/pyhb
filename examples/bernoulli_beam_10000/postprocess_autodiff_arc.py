...
from examples.bernoulli_beam_10000.run_autodiff_arc import DEFAULT_PLOT_DOFS, FREQUENCY_RESOLUTION, HARMONICS
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Postprocess the 10000-DOF Bernoulli beam autodiff result.")
