...
from examples.bernoulli_beam_10000.autodiff_model import BernoulliBeam10000AutodiffModel
...
DEFAULT_PLOT_DOFS = (9998,)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the 10000-DOF Bernoulli beam autodiff example.")
...
def build_initial_coefficients(model: BernoulliBeam10000AutodiffModel, order: int) -> NDArray[np.float64]:
...
def run_from_args(args: argparse.Namespace) -> None:
    model = BernoulliBeam10000AutodiffModel()
