...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the MZS-QZS isolator subharmonic autodiff arc-length example.")
...
def build_config(args: argparse.Namespace, init_omega: float) -> ContinuationAutodiffConfig:
