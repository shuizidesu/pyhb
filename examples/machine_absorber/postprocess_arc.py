...
from examples.machine_absorber.model import MachineAbsorberModel
from examples.machine_absorber.run_arc import DEFAULT_PLOT_DOFS, FREQUENCY_RESOLUTION, HARMONICS
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Postprocess the machine-absorber full continuation result.")
