...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the machine-absorber full arc-length example.")
...
def build_initial_coefficients(model: MachineAbsorberModel, order: int) -> NDArray[np.float64]:
