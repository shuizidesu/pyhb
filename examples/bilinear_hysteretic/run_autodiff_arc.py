...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the bilinear hysteretic autodiff arc-length example.")
...
def build_initial_coefficients(model: BilinearHystereticAutodiffModel, order: int) -> NDArray[np.float64]:
