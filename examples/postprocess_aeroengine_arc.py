...
from examples.example_aeroengine_arc import DEFAULT_PLOT_DOFS, FREQUENCY_RESOLUTION, HARMONICS


DEFAULT_INPUT = Path("results/example_aeroengine_arc.npz")
DEFAULT_OUTPUT = Path("results/example_aeroengine_arc.png")
