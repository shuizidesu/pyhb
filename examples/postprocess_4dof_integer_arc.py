...
from examples.example_4dof_integer_arc import DEFAULT_PLOT_DOFS, FREQUENCY_RESOLUTION, HARMONICS


DEFAULT_INPUT = Path("results/example_4dof_integer_arc.npz")
DEFAULT_OUTPUT = Path("results/example_4dof_integer_arc.png")
