...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the MZS-QZS isolator analytical arc-length example.")
...
def build_initial_coefficients(model: MzsQzsModel, order: int) -> NDArray[np.float64]:
