...
from examples.mzs_qzs_isolator.model import MzsQzsModel
from examples.mzs_qzs_isolator.run_arc import DEFAULT_PLOT_DOFS, FREQUENCY_RESOLUTION, HARMONICS
...
DEFAULT_RMS_OUTPUT = Path(__file__).resolve().parent / "results" / "arc_rms.npz"
DEFAULT_STABILITY_OUTPUT = Path(__file__).resolve().parent / "results" / "arc_floquet.npz"
DEFAULT_SAMPLE_COUNT = 2048


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Postprocess the MZS-QZS isolator analytical continuation result.")
